namespace CursedAmongUs.Source.Others
{
	internal static class CursedBlockedWords
	{
		...
		/*private static readonly String[] UnblockedAll =
		{
			...
			"fuc", "b!tch", "sex", "shit^", "p0rn"
		};

		private static readonly String[] BlockedAll =
		{
			"sus", "discord", "comma", "minecraft", "roblox", "cod", "poop", "red", "pgg", "cursed", "mod", "curse",
			"love", "trump", "biden", "donald", "joe", "hillary", "clinton", "barack", "obama", "germany", "german",
			"italy", "italian", "communist", "lmfao", "lmao", "fml", "gtfo", "omfg", "wtf", "ffs", "sext", "vented",
